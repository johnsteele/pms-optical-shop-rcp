package com.steelejr.greenwood.rcp.editors;
...
import com.steelejr.greenwood.rcp.Activator;
import com.steelejr.greenwood.rcp.model.Patient;
import com.steelejr.greenwood.rcp.model.Person;
...
public class PatientEditor extends EditorPart {
	...
	private void createFormToolbar () {
		...
		fSaveAction.setImageDescriptor(Activator.imageDescriptorFromPlugin(Activator.PLUGIN_ID, "icons/images/Save.gif"));
...
//		fForm.getToolBarManager().add(save2);
	...
	private void createWebsiteSection () {
		...
		final Text emailText = fToolkit.createText(client, fPatient.getWebInfo().getEmail());
		emailText.setLayoutData(new GridData(SWT.FILL, SWT.FILL, true, false));
		emailText.addKeyListener(new KeyAdapter() {
			@Override
			public void keyReleased(KeyEvent e) {
				fPatient.getWebInfo().setEmail(emailText.getText());
			}
		});
		
		fToolkit.createLabel (client, "Username: ");
		final Text userText = fToolkit.createText (client, fPatient.getWebInfo().getUsername());
		userText.setLayoutData(new GridData (SWT.FILL, SWT.FILL, true, false));
		userText.addKeyListener(new KeyAdapter() {
			@Override
			public void keyReleased(KeyEvent e) {
				fPatient.getWebInfo().setUsername(userText.getText());
			}
		});
		
		fToolkit.createLabel (client, "Password: ");
		final Text passText = fToolkit.createText(client, fPatient.getWebInfo().getPassword());
		passText.setLayoutData(new GridData (SWT.FILL, SWT.FILL, true, false));
		passText.addKeyListener(new KeyAdapter() {
			@Override
			public void keyReleased(KeyEvent e) {
				fPatient.getWebInfo().setPassword(passText.getText());
			}
		});
	...
	private void createDoctorSection () {
		...
		final Text docText = fToolkit.createText(practiceComp, fPatient.getEyeCareInfo().getDoctor());
		docText.setLayoutData(new GridData(SWT.FILL, SWT.FILL, true, false));
		docText.addKeyListener(new KeyAdapter() {
			@Override
			public void keyReleased(KeyEvent e) {
				fPatient.getEyeCareInfo().setDoctor(docText.getText());
			}
		});
	...
	private void createContactSection () {
		...
		final Text addr1Text = fToolkit.createText(addressComp, fPatient.getContactInfo().getAddress1());
		addr1Text.setLayoutData(new GridData (SWT.FILL, SWT.FILL, true, false));
		addr1Text.addKeyListener(new KeyAdapter() {
			@Override
			public void keyReleased(KeyEvent e) {
				fPatient.getContactInfo().setAddress1(addr1Text.getText());
			}
		});
		
		// Address2
		fToolkit.createLabel(addressComp, "Address2: ");
		final Text addr2Text = fToolkit.createText(addressComp, fPatient.getContactInfo().getAddress2());
		addr2Text.setLayoutData(new GridData(SWT.FILL, SWT.FILL, true, false));
		addr2Text.addKeyListener(new KeyAdapter() {
			@Override
			public void keyReleased(KeyEvent e) {
				fPatient.getContactInfo().setAddress2(addr2Text.getText());
			}
		}); 
		
		// Address3
		fToolkit.createLabel(addressComp, "Address3: ");
		final Text addr3Text = fToolkit.createText(addressComp, fPatient.getContactInfo().getAddress3());
		addr3Text.setLayoutData(new GridData(SWT.FILL, SWT.FILL, true, false));
		addr3Text.addKeyListener(new KeyAdapter() {
			@Override
			public void keyReleased(KeyEvent e) {
				fPatient.getContactInfo().setAddress3(addr3Text.getText());
			}
		});
		
		// City
		fToolkit.createLabel(addressComp, "City: ");
		final Text cityText = fToolkit.createText(addressComp, fPatient.getContactInfo().getCity());
		cityText.setLayoutData(new GridData (SWT.FILL, SWT.FILL, true, false));
		cityText.addKeyListener(new KeyAdapter() {
			@Override
			public void keyReleased(KeyEvent e) {
				fPatient.getContactInfo().setCity(cityText.getText());
			}
		});
		
		// State
		fToolkit.createLabel(addressComp, "State: ");
		final Text stateText = fToolkit.createText(addressComp, fPatient.getContactInfo().getState());
		stateText.setLayoutData(new GridData (SWT.FILL, SWT.FILL, true, false));
		stateText.addKeyListener(new KeyAdapter() {
			@Override
			public void keyReleased(KeyEvent e) {
				fPatient.getContactInfo().setState(stateText.getText());
			}
		});
		
		// Zip
		fToolkit.createLabel(addressComp, "Zipcode: ");
		final Text zipText = fToolkit.createText(addressComp, String.valueOf(fPatient.getContactInfo().getZip()));
		zipText.setLayoutData(new GridData (SWT.FILL, SWT.FILL, true, false));	
		zipText.addKeyListener(new KeyAdapter() {
			@Override
			public void keyReleased(KeyEvent e) {
				fPatient.getContactInfo().setZip(Integer.valueOf(zipText.getText()));
			}
		});
		...
		final Text phoneText = fToolkit.createText(contactComp, fPatient.getContactInfo().getHome_phone());
		phoneText.setLayoutData(new GridData (SWT.FILL, SWT.FILL, true, false));
		phoneText.addKeyListener(new KeyAdapter() {
			@Override
			public void keyReleased(KeyEvent e) {
				fPatient.getContactInfo().setHome_phone(phoneText.getText());
			}
		});
		
		// Mobile Phone
		fToolkit.createLabel(contactComp, "Mobile Phone: ");
		final Text mobileText = fToolkit.createText(contactComp, fPatient.getContactInfo().getCell_phone());
		mobileText.setLayoutData(new GridData (SWT.FILL, SWT.FILL, true, false));
		mobileText.addKeyListener(new KeyAdapter() {
			@Override
			public void keyReleased(KeyEvent e) {
				fPatient.getContactInfo().setCell_phone(mobileText.getText());
			}
		});
		
		// Business Phone
		fToolkit.createLabel(contactComp, "Business: ");
		final Text businessText = fToolkit.createText(contactComp, fPatient.getContactInfo().getWork_phone());
		businessText.setLayoutData(new GridData (SWT.FILL, SWT.FILL, true, false));
		businessText.addKeyListener(new KeyAdapter() {
			@Override
			public void keyReleased(KeyEvent e) {
				fPatient.getContactInfo().setWork_phone(businessText.getText());
			}
		});
		
		// Fax
		fToolkit.createLabel(contactComp, "Fax: ");
		final Text faxText = fToolkit.createText(contactComp, fPatient.getContactInfo().getFax());
		faxText.setLayoutData(new GridData (SWT.FILL, SWT.FILL, true, false));
		faxText.addKeyListener(new KeyAdapter() {
			@Override
			public void keyReleased(KeyEvent e) {
				fPatient.getContactInfo().setFax(faxText.getText());
			}
		});
